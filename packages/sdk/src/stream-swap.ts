...
// toon#210 (ADR 0003 stage 3): `AccumulatedClaim` is a SETTLEMENT type and was
// relocated to `settlement/accumulated-claim.ts` so that deleting this legacy
// sender (toon#211) does not take the settlement surface with it. Both barrels
// (`index.ts`, `swap.ts`) now export it from there; this file is a consumer.
import type { AccumulatedClaim } from './settlement/accumulated-claim.js';
import {
  parseStreamReceipt,
  ReceiptChainTracker,
  type StreamReceipt,
