...
const EIP712DOMAIN_TYPEHASH = keccak_256(
...
const DOMAIN_NAME_HASH = keccak_256(new TextEncoder().encode('RollingSwapChannel'));

/** keccak256("2") = 0xad7c5bef027816a800da1736444fb58a807ef4c9603b7848673f7e3a68eb14a5 */
const DOMAIN_VERSION_HASH = keccak_256(new TextEncoder().encode('2'));
...
const CLAIM_TYPEHASH = keccak_256(
  new TextEncoder().encode(
...
const COOP_CLOSE_TYPEHASH = keccak_256(
  new TextEncoder().encode(
