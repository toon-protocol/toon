...
//
// Observed in connector on issue #430 (push at 77 min) and twice on #422 (61
// min, 73 min) — every one of those runs lost a COMPLETED implementation, since
// the failure lands after all the expensive work is done. Raising
// `timeout-minutes` on its own makes this worse, not better: the extra minutes
// are spent and the push still fails.
//
// THE FIX
// -------
